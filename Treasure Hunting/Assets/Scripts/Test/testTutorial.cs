...
public class testTutorial : MonoBehaviour
{
    ...
    private GameObject tutorialTextObj; //説明分のObj
    private GameObject cursor;          //矢印オブジェクト
    private GameObject pwSwitch;        //パスワードswitchオブジェクト
    ...
    //Toggleオブジェクト
    private GameObject walkToggleObj;//歩くToggle
    private GameObject dashToggleObj;//走るToggle
    private GameObject pwToggleObj;  //パスワードToggle
    private GameObject keyToggleObj; //鍵Toggle
    ...
    void Start()
    {
        ...
        //パスワードswitch情報取得
        pwSwitch = GameObject.Find("PassObj/PwSwitch");
        //パスワードswitchのコライダー取得
    ...
    void ChangePhase(Phase phase)
    {
        switch (phase)
        {
            case Phase.walk:
                //Text変更
                tutorialText.text = "WASDで移動をしてみよう";
            ...
            case Phase.dash:
                ...
                //Text変更
                tutorialText.text = "上のスタミナゲージに注意しながら\nWASD+LShiftでダッシュしよう";
                //Text変更
                //tutorialText.text = "上のスタミナゲージに注意しながら\nWASD+LShiftでダッシュしよう";
                //
            ...
            case Phase.passWord:
                ...
                tutorialText.text = "矢印の先にあるスイッチに触れ\n０１２となるようにクリックしよう";
                ...
                //矢印をターゲットの方向へ
                aim(pwSwitch.transform.position);
            ...
            case Phase.key:
                ...
                tutorialText.text = "3つの鍵を取り指定された扉の前で\nEキーを押そう";
    ...
    void SetColorToggle(Toggle toggle,bool alpha)
    {
        ...
        else
        {
            ...
            TextImage.color = new Color(0, 0, 0, 1f);
        }
    }
}
